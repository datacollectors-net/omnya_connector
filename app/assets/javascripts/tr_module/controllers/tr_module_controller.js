...
const CONTEXT_SYNC_RELOADED_KEY = "tr_module_context_sync_reloaded"

// If the engine is mounted at a prefix (e.g. mount TrModule::Engine => "/my_prefix"),
...
export default class extends Controller {
  ...
  handleMessage(event) {
    ...
    if (!payload || payload.type !== "external-module:context") {
      return
    }

    if (payload.moduleKey !== this.moduleKeyValue) {
      return
    }
