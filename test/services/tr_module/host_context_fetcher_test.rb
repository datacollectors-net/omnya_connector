...
class TrModule::HostContextFetcherTest < ActiveSupport::TestCase
  test "raises error when token is blank" do
    error = assert_raises(TrModule::HostContextFetcher::Error) do
      TrModule::HostContextFetcher.call(
        token: "",
  ...
  test "raises error for invalid URI" do
    ...
    assert_kind_of TrModule::HostContextFetcher::Error, error
  end
end
